...
public class ScoreboardCommand extends VanillaCommand {
    ...
    private static final List<String> TEAMS_OPTION_CHOICES = ImmutableList.of("color", "friendlyfire", "seeFriendlyInvisibles", "tagVisible");
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("objectives")) {
            ...
            if (args[1].equalsIgnoreCase("list")) {
                ...
                if (!option.equals("friendlyfire") && !option.equals("color") && !option.equals("seefriendlyinvisibles") && !option.equals("tagvisible")) {
                    sender.sendMessage(ChatColor.RED + "/scoreboard teams option <team> <friendlyfire|color|seefriendlyinvisibles> <value>");
                    return false;
                }
                if (args.length == 4) {
