...
public final class CraftServer implements Server {
    ...
    public void reload() {
        ...
        net.tacospigot.TacoSpigotConfig.init(); // TacoSpigot
        for (WorldServer world : console.worlds) {
            ...
            world.tacoSpigotWorldConfig.init(); // TacoSpigot
        }
        ...
        net.tacospigot.TacoSpigotConfig.registerCommands(); // TacoSpigot
    ...
    public List<String> tabCompleteChat(Player player, String message) {
        ...
        for (Player p : getOnlinePlayers()) {
            ...
            if (!p.hasMetadata("invisible") && StringUtil.startsWithIgnoreCase(p.getDisguisedName(), token)) {
