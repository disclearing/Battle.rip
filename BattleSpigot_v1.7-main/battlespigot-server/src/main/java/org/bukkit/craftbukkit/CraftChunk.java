...
public class CraftChunk implements Chunk {
    ...
    @Override
    public dev.nulledcode.spigot.chunksnapshot.ChunkSnapshot takeSnapshot() {
        net.minecraft.server.Chunk handle = getHandle();
        dev.nulledcode.spigot.chunksnapshot.CraftChunkSnapshot snap = new dev.nulledcode.spigot.chunksnapshot.CraftChunkSnapshot();
    ...
    @Override
    public void restoreSnapshot(dev.nulledcode.spigot.chunksnapshot.ChunkSnapshot snapshot) {
        dev.nulledcode.spigot.chunksnapshot.CraftChunkSnapshot snap = (dev.nulledcode.spigot.chunksnapshot.CraftChunkSnapshot) snapshot;
        net.minecraft.server.Chunk handle = getHandle();
