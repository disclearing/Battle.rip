...
final class CraftTeam extends CraftScoreboardComponent implements Team {
    ...
    @Override
    public void setTagVisible(boolean enabled) throws IllegalStateException {
        team.setTagVisible(enabled);
    }

    @Override
    public boolean getTagVisible() throws IllegalStateException {
        return team.isTagVisible();
    }
