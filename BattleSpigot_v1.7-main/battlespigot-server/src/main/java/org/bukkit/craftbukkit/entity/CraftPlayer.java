...
public class CraftPlayer extends CraftHumanEntity implements Player {
    ...
    // nulled start
    private boolean pickingcobble = true;
    // nulled end
    ...
    @Override
    public void setPickingCobble(boolean b) {
        pickingcobble = b;
    }

    @Override
    public boolean isPickingCobble() {
        return pickingcobble;
    }

    @Override
    public void sendPacket(Object packet) {
        ((EntityPlayer) getPlayer()).playerConnection.sendPacket((Packet) packet);
    }
    ...
    public void disguise(String name, String[] texture) {
        ...
        if (texture != null) {
            ...
            disguisedProfile.getProperties().put("textures", new net.minecraft.util.com.mojang.authlib.properties.Property("textures", texture[0], texture[1]));
        }
        ...
        if (trackerEntry != null) {
            ...
            /*WorldServer worldServer = this.server.getServer().getWorldServer(getHandle().dimension);
            worldServer.removeEntity(getHandle());
            worldServer.addEntity(getHandle());
            worldServer.getPlayerChunkMap().addPlayer(getHandle());*/
        }
    ...
    public void undisguise() {
        ...
        //this.server.getServer().getPlayerList().a(getHandle().playerConnection.networkManager, this.server.getServer().getPlayerList().processLogin(getHandle().getProfile(), getHandle()));
    ...
    public boolean teleport(Location location, PlayerTeleportEvent.TeleportCause cause) {
        ...
        if (46340 <= FastMath.abs(locationChunkX) || 46340 <= FastMath.abs(locationChunkZ)) {
    ...
    public int getVersion() {
        return getHandle().playerConnection.networkManager.getVersion();
    }
