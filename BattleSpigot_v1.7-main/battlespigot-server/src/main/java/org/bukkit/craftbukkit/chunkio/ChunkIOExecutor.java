...
public class ChunkIOExecutor {
    static final int BASE_THREADS = FastMath.min(6, 2);
    ...
    public static void adjustPoolSize(int players) {
        int size = FastMath.max(BASE_THREADS, (int) FastMath.ceil(players / SpigotConfig.playersPerChunkIOThread)); // Poweruser
