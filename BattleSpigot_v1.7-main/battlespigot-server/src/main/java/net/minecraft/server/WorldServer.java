...
public class WorldServer extends World {
    ...
    private final BlockActionDataList[] S = new BlockActionDataList[]{new BlockActionDataList(null), new BlockActionDataList(null)};
    private int T;
    ...
    public void doTick() {
        ...
        if (!SpigotConfig.disableBiomeCacheCleanup) {
        ...
        for (net.minecraft.util.gnu.trove.iterator.TLongShortIterator iter = chunkTickList.iterator(); iter.hasNext(); ) {
            ...
            if (this.random.nextInt(100000) == 0 && this.Q() && this.P()) {
                ...
                if (this.isRainingAt(j1, l1, k1)) {
                    this.strikeLightning(new EntityLightning(this, j1, l1, k1));
                }
            }
    ...
    public boolean a(boolean flag) {
        ...
        if (false) { // PaperSpigot
            ...
            for (int j = 0; j < i; ++j) {
                nextticklistentry = this.N.first();
    ...
    private boolean a(BlockActionData blockactiondata) {
        ...
        return block == blockactiondata.f() && block.a(this, blockactiondata.a(), blockactiondata.b(), blockactiondata.c(), blockactiondata.d(), blockactiondata.e());
    }
