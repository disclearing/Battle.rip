...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    public void e() {
        ...
        float f1 = (float) FastMath.atan(-this.motY * 0.20000000298023224D) * 15.0F;
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource != null) {
            this.motX = (double) (-FastMath.cos((this.az + this.yaw) * 3.1415927F / 180.0F) * 0.1F);
            this.motZ = (double) (-FastMath.sin((this.az + this.yaw) * 3.1415927F / 180.0F) * 0.1F);
        } else {
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            if (flag) {
                ...
                entityitem.motX = -FastMath.sin(f2) * f1;
                entityitem.motZ = FastMath.cos(f2) * f1;
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (this.sleeping) {
            this.bB = new ChunkCoordinates((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY), (int) FastMath.floor(this.locZ));
            this.a(true, true, false);
        }
        ...
        if (this.isInvulnerable()) {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                if (false && f == 0.0F) { // CraftBukkit - Don't filter out 0 damage
                    ...
                    this.a(StatisticList.u, FastMath.round(f * 10.0F));
            ...
            if (!entity.j(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        ...
                        if (entity instanceof EntityLiving) {
                            this.a(StatisticList.t, FastMath.round(f * 10.0F));
                            if (j > 0) {
                                // CraftBukkit start - Call a combust event when somebody hits with a fire enchanted item
    ...
    public EnumBedResult a(int i, int j, int k) {
        if (!this.world.isStatic) {
            ...
            if (FastMath.abs(this.locX - (double) i) > 3.0D || FastMath.abs(this.locY - (double) j) > 2.0D || FastMath.abs(this.locZ - (double) k) > 3.0D) {
    ...
    public void checkMovement(double d0, double d1, double d2) {
        if (this.vehicle == null) {
            ...
            if (this.a(Material.WATER)) { // in water
                i = (int) FastMath.round(FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);
                if (i > 0) {
                ...
                i = (int) FastMath.round(FastMath.sqrt(d0 * d0 + d2 * d2) * 100.0F);
                if (i > 0) {
                ...
                if (d1 > 0.0D) {
                    this.a(StatisticList.k, (int) FastMath.round(d1 * 100.0D));
                }
    ...
    private void l(double d0, double d1, double d2) {
        if (this.vehicle != null) {
            int i = (int) FastMath.round(FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);

            if (i > 0) {
                if (this.vehicle instanceof EntityMinecartAbstract) {
                    this.a(StatisticList.n, i);
                    if (this.e == null) {
                        this.e = new ChunkCoordinates((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY), (int) FastMath.floor(this.locZ));
                    } else if ((double) this.e.e((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY), (int) FastMath.floor(this.locZ)) >= 1000000.0D) {
    ...
    protected void b(float f) {
        if (!this.abilities.canFly) {
            if (f >= 2.0F) {
                this.a(StatisticList.j, (int) FastMath.round((double) f * 100.0D));
            }
