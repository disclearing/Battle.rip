...
public class EntityZombie extends EntityMonster {
        ...
        if (!super.damageEntity(damagesource, f)) {
            ...
            if (entityliving != null && this.world.difficulty == EnumDifficulty.HARD && (double) this.random.nextFloat() < this.getAttributeInstance(bp).getValue()) {
                ...
                for (int l = 0; l < 50; ++l) {
                    ...
                    if (World.a((IBlockAccess) this.world, i1, j1 - 1, k1)) { // MineHQ
    ...
    protected void a(int i) {
        ...
        this.addEffect(new MobEffect(MobEffectList.INCREASE_DAMAGE.id, i, FastMath.min(this.world.difficulty.a() - 1, 0)));
