...
public class ItemWorldMap extends ItemWorldMapBase {
    ...
    public WorldMap getSavedMap(ItemStack itemstack, World world) {
        ...
        if (worldmap == null && !world.isStatic) {
            ...
            worldmap.centerX = FastMath.round((float) world.getWorldData().c() / (float) i) * i;
            worldmap.centerZ = FastMath.round((float) (world.getWorldData().e() / i)) * i;
    ...
    public void a(World world, Entity entity, WorldMap worldmap) {
        ...
        if (((WorldServer) world).dimension == worldmap.map && entity instanceof EntityHuman) {
            ...
            int l = (int) FastMath.floor(entity.locX - (double) j) / i + 64;
            int i1 = (int) FastMath.floor(entity.locZ - (double) k) / i + 64;
            int j1 = 128 / i;
