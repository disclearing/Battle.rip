...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    protected void aD() {
        super.aD();
        this.getAttributeInstance(GenericAttributes.maxHealth).setValue(700.0D);
    }
    ...
    public void e() {
        ...
        if (this.world.isStatic) {
            f = (float) FastMath.cos(this.by * 3.1415927F * 2.0F);
            f1 = (float) FastMath.cos(this.bx * 3.1415927F * 2.0F);
            if (f1 <= -0.3F && f >= -0.3F) {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.bP();
            f = (float) (0.2F / (FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 10.0F + 1.0F));
            ...
            if (this.world.isStatic) {
                ...
                d1 /= (double) FastMath.sqrt(d0 * d0 + d2 * d2);
                f3 = 0.6F;
                if (d1 < (double) (-f3)) {
                    d1 = (double) (-f3);
                }
                ...
                this.yaw = MathHelper.g(this.yaw);
                double d8 = 180.0D - FastMath.atan2(d0, d2) * 180.0D / 3.1415927410125732D;
                ...
                Vec3D vec3d1 = Vec3D.a((double) FastMath.sin(this.yaw * 3.1415927F / 180.0F), this.motY, (double) (-FastMath.cos(this.yaw * 3.1415927F / 180.0F))).a();
            ...
            f3 = (float) FastMath.sin(this.yaw * 3.1415927F / 180.0F - this.bf * 0.01F);
            float f13 = (float) FastMath.cos(this.yaw * 3.1415927F / 180.0F - this.bf * 0.01F);
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                float f16 = (float) FastMath.cos(f14);
                float f17 = 1.5F;
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (entity instanceof EntityLiving) {
                if (entity.damageEntity(DamageSource.mobAttack(this), 10.0F)) {
                     entity.g((double) (-FastMath.sin(this.yaw * 3.1415927F / 180.0F) * 3.0F), 0.8D, (double) (FastMath.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * 3.0F));
                }
            }
        }
    }
    ...
    private boolean a(AxisAlignedBB axisalignedbb) {
        ...
        int j = (int) FastMath.floor(axisalignedbb.b);
        int k = (int) FastMath.floor(axisalignedbb.c);
        int l = (int) FastMath.floor(axisalignedbb.d);
        int i1 = (int) FastMath.floor(axisalignedbb.e);
    ...
    public boolean a(EntityComplexPart entitycomplexpart, DamageSource damagesource, float f) {
        ...
        float f3 = (float) FastMath.cos(f1);
    ...
    protected void aF() {
        ...
        if (this.bB == 200 && !this.world.isStatic) {
            ...
            this.b((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locZ));
            this.die();
        }
    }
