...
public class EnchantmentManager {
    ...
    public static int getDepthStriderEnchantmentLevel(EntityLiving entityliving) {
        return getEnchantmentLevel(Enchantment.DEPTH_STRIDER.id, entityliving.getEquipment());
    }
