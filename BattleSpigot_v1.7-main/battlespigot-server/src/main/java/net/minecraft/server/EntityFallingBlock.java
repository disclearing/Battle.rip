...
public class EntityFallingBlock extends Entity {
    ...
    public void die(){
        ...
        org.bukkit.Material material = CraftMagicNumbers.getMaterial(id);


        if (material == org.bukkit.Material.DROPPER || material == org.bukkit.Material.JACK_O_LANTERN) {
            CraftEventFactory.callAirdropDieEvent(this.getBukkitEntity());
        }
