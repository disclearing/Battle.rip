...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public EntityPlayer(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager){
        this(minecraftserver, worldserver, gameprofile, playerinteractmanager, true);
    }

    public EntityPlayer(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager, boolean statics) {
        ...
        if (!worldserver.worldProvider.g && worldserver.getWorldData().getGameType() != EnumGamemode.ADVENTURE) {
            int l = FastMath.max(5, minecraftserver.getSpawnProtection() - 6);
        ...
        if(statics) this.bO = minecraftserver.getPlayerList().a((EntityHuman) this);
        else this.bO = null;
        this.W = 0.0F;
        this.height = 0.0F;
