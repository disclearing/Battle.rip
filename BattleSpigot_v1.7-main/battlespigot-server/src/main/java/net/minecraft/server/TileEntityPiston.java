...
public class TileEntityPiston extends TileEntity {
        ...
        if (axisalignedbb != null) {
            ...
            if (!list.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    entity.move(f1 * (float) Facing.b[this.j], f1 * (float) Facing.c[this.j], f1 * (float) Facing.d[this.j]);
                }
    ...
    public void f() {
        if (this.n < 1.0F && this.world != null && BattleSpigot.isPositionOfTileEntityInUse(world, x, y, z)) {
            this.n = this.m = 1.0F;
    ...
    public void h() {
        ...
        if (BattleSpigot.isPositionOfTileEntityInUse(world, x, y, z)) {
            this.n = this.m;
            if (this.n >= 1.0F) {
                this.a(1.0F, 0.25F);
                this.world.p(this.x, this.y, this.z);
