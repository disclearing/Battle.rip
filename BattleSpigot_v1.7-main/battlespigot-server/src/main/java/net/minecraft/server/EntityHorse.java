...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
    ...
    public boolean cr() {
        ...
        int j = (int) FastMath.floor(this.locZ);
    ...
    protected void b(float f) {
        ...
        if (i > 0) {
            ...
            Block block = this.world.getType((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY - 0.2D - (double) this.lastYaw), (int) FastMath.floor(this.locZ));
    ...
    public void e() {
        ...
        if (!this.world.isStatic) {
            ...
            if (!this.cm() && this.passenger == null && this.random.nextInt(300) == 0 && this.world.getType((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY) - 1, (int) FastMath.floor(this.locZ)) == Blocks.GRASS) {
                this.o(true);
            }
    ...
    public void e(float f, float f1) {
        if (this.passenger != null && this.passenger instanceof EntityLiving && this.cu()) {
            ...
            if (this.bt > 0.0F && !this.cj() && this.onGround) {
                ...
                this.al = true;
                if (f1 > 0.0F) {
                    float f2 = (int) FastMath.sin(this.yaw * 3.1415927F / 180.0F);
                    float f3 = (int) FastMath.cos(this.yaw * 3.1415927F / 180.0F);
            ...
            float f4 = (int) FastMath.sqrt(d0 * d0 + d1 * d1) * 4.0F;
    ...
    public void ac() {
        super.ac();
        if (this.bM > 0.0F) {
            float f = (int) FastMath.sin(this.aM * 3.1415927F / 180.0F);
            float f1 = (int) FastMath.cos(this.aM * 3.1415927F / 180.0F);
