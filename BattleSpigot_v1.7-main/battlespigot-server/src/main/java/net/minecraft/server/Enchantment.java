...
public abstract class Enchantment {
    ...
    //private static final File CONFIG_FILE = new File("config/server", "enchantments.yml");
    //protected static YamlConfiguration config = YamlConfiguration.loadConfiguration(CONFIG_FILE);
    private static final YamlConfiguration config = YamlConfiguration.loadConfiguration(new File("config/server", "enchantments.yml"));
    ...
    public static final Enchantment DEPTH_STRIDER = new EnchantmentDepthStrider(8, 2);
    ...
    protected Enchantment(int i, int j, EnchantmentSlotType enchantmentslottype) {
        ...
        //MinecraftServer.getLogger().info("limited enchantment " + configName + " to " + startLevel + "-" + maxLevel + " (weight: " + weight + ").");
    }
