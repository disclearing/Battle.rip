...
public class EntityTNTPrimed extends Entity {
    ...
    // PaperSpigot end
        ...
        //float f = (float) (FastMath.random() * 3.1415927410125732D * 2.0D); // PaperSpigot - Fix directional TNT bias

        this.motX = 0; // PaperSpigot - Fix directional TNT bias //(double) (-((float) FastMath.sin((double) f)) * 0.02F);
        this.motY = 0.20000000298023224D;
        this.motZ = 0; // PaperSpigot - Fix directional TNT bias //(double) (-((float) FastMath.cos((double) f)) * 0.02F);
        this.fuseTicks = 80;
        this.lastX = d0;
        this.lastY = d1;
        this.lastZ = d2;
