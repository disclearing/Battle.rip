...
import dev.nulledcode.spigot.util.autosave.AutoSave;
import dev.nulledcode.spigot.util.timings.ExtendedCustomTimingsHandler;
...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    // lSpigot start
    public static ScheduledExecutorService asyncExecutor = Executors.newSingleThreadScheduledExecutor();
    // lSpigot end
            ...
            if (this.init()) {
                ...
                while (this.isRunning) {
                    ...
                    if (wait > 0) {
                        ...
                        catchupTime = FastMath.min(1000000000, FastMath.abs(wait));
                    }
    ...
    protected void u() throws ExceptionWorldConflict { // CraftBukkit - added throws
        ...
        if (i - this.V >= 5000000000L) {
            ...
            GameProfile[] agameprofile = new GameProfile[FastMath.min(this.C(), 12)];
    ...
    public String getServerModName() {
        return "BattleSpigot"; // MineHQ - ayy lmao
    }
