...
public class TileEntityFurnace extends TileEntity implements IWorldInventory {
    ...
    private boolean canBurn() {
        if (this.items[0] == null) {
            ...
            return ((!BattleSpigot.isPositionOfTileEntityInUse(world, x, y, z)) || itemstack != null) && (this.items[2] == null || (this.items[2].doMaterialsMatch(itemstack) && (this.items[2].count + itemstack.count <= this.getMaxStackSize() && this.items[2].count < this.items[2].getMaxStackSize() || this.items[2].count + itemstack.count <= itemstack.getMaxStackSize())));
        }
    }
