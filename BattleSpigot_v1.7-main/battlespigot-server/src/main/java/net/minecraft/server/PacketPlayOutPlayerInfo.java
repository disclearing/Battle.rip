...
public class PacketPlayOutPlayerInfo extends Packet {
    ...
    @Setter public int action;
    // private int length; We don't batch (yet)
    @Setter public GameProfile player;

    @Setter public int gamemode;
    @Setter public int ping;
    @Setter public String username;

    public PacketPlayOutPlayerInfo() {
    }

    public PacketPlayOutPlayerInfo(int action, GameProfile player, int gamemode, int ping, String username) {
        this.action = action;
        this.player = player;
