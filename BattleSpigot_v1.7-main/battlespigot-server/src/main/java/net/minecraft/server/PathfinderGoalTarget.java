...
public abstract class PathfinderGoalTarget extends PathfinderGoal {
    ...
    protected boolean a(EntityLiving entityliving, boolean flag) {
        if (entityliving == null) {
            ...
            if (!this.c.b((int) FastMath.floor(entityliving.locX), (int) FastMath.floor(entityliving.locY), (int) FastMath.floor(entityliving.locZ))) {
                return false;
    ...
    private boolean a(EntityLiving entityliving) {
        ...
        if (pathentity == null) {
            ...
            if (pathpoint == null) {
                ...
                int i = pathpoint.a - (int) FastMath.floor(entityliving.locX);
                int j = pathpoint.c - (int) FastMath.floor(entityliving.locZ);
