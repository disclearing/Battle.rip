...
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJob;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJobEntity;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJobPosition;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchQueuingManager;
...
public abstract class EntityCreature extends EntityInsentient {
    ...
    public static final UUID h = FastUUID.parseUUID("E199AD21-BA8A-4C53-8D13-6182D5C69D3A");
    ...
    protected void bq() {
        ...
        int i = (int) FastMath.floor(this.boundingBox.b + 0.5D);
        boolean flag = this.M();
        ...
        if (this.pathEntity != null && this.random.nextInt(100) != 0) {
            ...
            if (vec3d != null) {
                ...
                float f2 = (float) (FastMath.atan2(d2, d1) * 180.0D / 3.1415927410125732D) - 90.0F;
                ...
                if (this.bn && this.target != null) {
                    ...
                    this.yaw = (float) (FastMath.atan2(d5, d4) * 180.0D / 3.1415927410125732D) - 90.0F;
                    f3 = (f4 - this.yaw + 90.0F) * 3.1415927F / 180.0F;
                    this.bd = (float) (-FastMath.sin(f3) * this.be * 1.0F);
                    this.be = (float) (FastMath.cos(f3) * this.be * 1.0F);
                }
    ...
    protected void bQ() {
        ...
        for (int l = 0; l < 10; ++l) {
            int i1 = (int) FastMath.floor(this.locX + (double) this.random.nextInt(13) - 6.0D);
            int j1 = (int) FastMath.floor(this.locY + (double) this.random.nextInt(7) - 3.0D);
            int k1 = (int) FastMath.floor(this.locZ + (double) this.random.nextInt(13) - 6.0D);
    ...
    public boolean bU() {
        return this.b((int) FastMath.floor(this.locX), (int) FastMath.floor(this.locY), (int) FastMath.floor(this.locZ));
    }
