...
public abstract class EntityMonster extends EntityCreature implements IMonster {
    ...
    public boolean n(Entity entity) {
        ...
        if (flag) {
            if (i > 0) {
                entity.g((double) (-FastMath.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.5F), 0.1D, (double) (FastMath.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.5F));
                this.motX *= 0.6D;
                this.motZ *= 0.6D;
            }
    ...
    public boolean canSpawn() {
        return this.world.difficulty != EnumDifficulty.PEACEFUL && super.canSpawn();
    }
