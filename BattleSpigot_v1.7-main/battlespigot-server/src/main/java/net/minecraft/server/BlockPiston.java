...
public class BlockPiston extends Block {
    ...
    public static int a(World world, int i, int j, int k, EntityLiving entityliving) {
        if ((int) FastMath.abs((float) entityliving.locX - (float) i) < 2.0F && (int) FastMath.abs((float) entityliving.locZ - (float) k) < 2.0F) {
        ...
        int l = (int) FastMath.floor((double) (entityliving.yaw * 4.0F / 360.0F) + 0.5D) & 3;
