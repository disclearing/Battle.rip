...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World world, EntityLiving entityliving, EntityLiving entityliving1, float f, float f1) {
        ...
        if (d3 >= 1.0E-7D) {
            float f2 = (float) (FastMath.atan2(d2, d0) * 180.0D / 3.1415927410125732D) - 90.0F;
            float f3 = (float) (-(FastMath.atan2(d1, d3) * 180.0D / 3.1415927410125732D));
            double d4 = d0 / d3;
            double d5 = d2 / d3;
    ...
    public EntityArrow(World world, EntityLiving entityliving, float f) {
        ...
        this.height = 0.0F;
        this.motX = (double) (-FastMath.sin(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F));
        this.motZ = (double) (FastMath.cos(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F));
    ...
    public void h() {
        ...
        if (this.lastPitch == 0.0F && this.lastYaw == 0.0F) {
            ...
            this.lastYaw = this.yaw = (float) (FastMath.atan2(this.motX, this.motZ) * 180.0D / 3.1415927410125732D);
            this.lastPitch = this.pitch = (float) (FastMath.atan2(this.motY, (double) f) * 180.0D / 3.1415927410125732D);
        }
        ...
        if (this.inGround) {
            ...
            for (this.pitch = (float) (FastMath.atan2(this.motY, (double) f2) * 180.0D / 3.1415927410125732D); this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F) {
                ;
            }
