...
public class PathfinderGoalMeleeAttack extends PathfinderGoal {
    ...
    public boolean b() {
        ...
        return entityliving == null ? false : (!entityliving.isAlive() ? false : (!this.e ? !this.b.getNavigation().g() : this.b.b((int) FastMath.floor(entityliving.locX), (int) FastMath.floor(entityliving.locY), (int) FastMath.floor(entityliving.locZ))));
    }
    ...
    public void e() {
        ...
        this.c = FastMath.max(this.c - 1, 0);
        if (d0 <= d1 && this.c <= 20) {
            this.c = 20;
            if (this.b.be() != null) {
                this.b.ba();
