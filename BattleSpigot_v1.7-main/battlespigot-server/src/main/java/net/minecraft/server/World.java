...
import dev.nulledcode.spigot.util.*;
import dev.nulledcode.spigot.util.ThreadingManager.TaskQueueWorker;
import dev.nulledcode.spigot.util.autosave.AutoSaveWorldData;
import dev.nulledcode.spigot.util.generator.GeneratorConfig;
...
public abstract class World implements IBlockAccess {
    ...
    // MineHQ start
    private static final Function<EntityHuman, Double> invisibilityFunction = entityHuman -> {
    ...
    public final List<Entity> entityList = new RemoveAllFix<Entity>()
    {
        @Override
    ...
    public final net.tacospigot.TacoSpigotWorldConfig tacoSpigotWorldConfig;
    ...
    public boolean d;
    public final List<TileEntity> tileEntityList = new RemoveAllFix<>(); // CraftBukkit - ArrayList -> HashSet
    ...
    // MineHQ end
    private final long c = 16777215L;
    ...
    // Poweruser start
    private final LightingUpdater lightingUpdater = new LightingUpdater();
    private final TaskQueueWorker lightingQueue = ThreadingManager.createTaskQueue();
    ...
    public World(IDataManager idatamanager, String s, WorldSettings worldsettings, WorldProvider worldprovider, MethodProfiler methodprofiler, ChunkGenerator gen, org.bukkit.World.Environment env) {
        ...
        this.tacoSpigotWorldConfig = new net.tacospigot.TacoSpigotWorldConfig(s);
    ...
    public static boolean a(IBlockAccess iblockaccess, int i, int j, int k) {
        ...
        return block.getMaterial().k() && block.d() || (block instanceof BlockStairs ? (l & 4) == 4 : (block instanceof BlockStepAbstract ? (l & 8) == 8 : (block instanceof BlockHopper || (block instanceof BlockSnow && (l & 7) == 7))));
    }
    ...
    private void initializeHoppers() {
        if (this.spigotConfig.altHopperTicking) {
            for (TileEntity o : this.triggerHoppersList) {
                //if (o.getOwner().getInventory().getContents().length <= 50) continue;
                o.scheduleTicks();
    ...
    public float n(int var1, int var2, int var3) {
        return this.worldProvider.h[this.getLightLevel(var1, var2, var3)];
    }
    public int getLightLevel(int var1, int var2, int var3) {
        return this.calculateLightLevel(var1, var2, var3, true);
    }

    private int calculateLightLevel(int var1, int var2, int var3, boolean var4) {
        if (var1 >= -30000000 && var3 >= -30000000 && var1 < 30000000 && var3 < 30000000) {
            if (var4 && this.getType(var1, var2, var3).n()) {
    ...
    /*public boolean isLightLevel(int i, int j, int k, int level) {
        if (i >= -30000000 && k >= -30000000 && i < 30000000 && k < 30000000) {
            if (this.getType(i, j, k).n()) {
                ...
                return this.b(i, j, k - 1, false) >= level;
            } else {
                if (j >= 256) {
                    j = 255;
                }
    ...
    public MovingObjectPosition rayTrace(Vec3D position, Vec3D motion, boolean flag, boolean flag1, boolean flag2) {
        if (!Double.isNaN(position.a) && !Double.isNaN(position.b) && !Double.isNaN(position.c)) {
            if (!Double.isNaN(motion.a) && !Double.isNaN(motion.b) && !Double.isNaN(motion.c)) {
                int i = (int) FastMath.floor(motion.a);
                int j = (int) FastMath.floor(motion.b);
                int k = (int) FastMath.floor(motion.c);
                int l = (int) FastMath.floor(position.a);
                int i1 = (int) FastMath.floor(position.b);
                int j1 = (int) FastMath.floor(position.c);
                ...
                while (k1-- >= 0) {
                    ...
                    l = (int) (vec3d2.a = (int) FastMath.floor(position.a));
                    if (b0 == 5) {
                        --l;
                        ++vec3d2.a;
                    }

                    i1 = (int) (vec3d2.b = (int) FastMath.floor(position.b));
                    if (b0 == 1) {
                        --i1;
                        ++vec3d2.b;
                    }

                    j1 = (int) (vec3d2.c = (int) FastMath.floor(position.c));
                    if (b0 == 3) {
                        --j1;
                        ++vec3d2.c;
                    }
    ...
    public List getCubes(Entity entity, AxisAlignedBB axisalignedbb, Set<Block> set) {
        this.L.clear();
            ...
            for (int l1 = i1; l1 < j1; ++l1) {
                if (this.isLoaded(k1, 64, l1)) {
                    for (int i2 = k - 1; i2 < l; ++i2) {
                        Block block = this.getType(k1, i2, l1);
        ...
        for (int j2 = 0; j2 < list.size(); ++j2) {
            AxisAlignedBB axisalignedbb1 = ((Entity) list.get(j2)).boundingBox;
            ...
            for (int l1 = i1; l1 < j1; ++l1) {
                if (this.isLoaded(k1, 64, l1)) {
                    for (int i2 = k - 1; i2 < l; ++i2) {
                        ...
                        if (block != Blocks.AIR) block.a(this, k1, i2, l1, axisalignedbb, this.L, null);
                    }
                }
            }
        }
                ...
                for (int l1 = k; l1 < l; ++l1) {
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        if (block.getMaterial() == material) {
                            double d0 = (float) (l1 + 1) - BlockFluids.b(this.getData(k1, l1, i2));
    ...
    public boolean boundingBoxContainsMaterials(AxisAlignedBB boundingBox, Set<Block> matching) {
        int i = (int) FastMath.floor(boundingBox.a);
        int j = (int) FastMath.floor(boundingBox.d + 1.0D);
        int k = (int) FastMath.floor(boundingBox.b);
        int l = (int) FastMath.floor(boundingBox.e + 1.0D);
        int i1 = (int) FastMath.floor(boundingBox.c);
        int j1 = (int) FastMath.floor(boundingBox.f + 1.0D);
    ...
    public float a(Vec3D vec3d, AxisAlignedBB axisalignedbb) {
        ...
        double xOffset = (1.0 - FastMath.floor(1.0 / d0) * d0) / 2.0;
        double zOffset = (1.0 - FastMath.floor(1.0 / d2) * d2) / 2.0;
        // PaperSpigot end
        ...
        if (f > 0.15F) {
            ...
            if (j >= 0 && j < 256 && this.b(EnumSkyBlock.BLOCK, i, j, k) < 10) {
                ...
                if ((block == Blocks.STATIONARY_WATER || block == Blocks.WATER) && this.getData(i, j, k) == 0) {
                    ...
                    boolean flag1 = this.getType(i - 1, j, k).getMaterial() == Material.WATER;
    ...
    public boolean e(int i, int j, int k, boolean flag) {
        ...
        if (f > 0.15F) {
            ...
            if (j >= 0 && j < 256 && this.b(EnumSkyBlock.BLOCK, i, j, k) < 10) {
                ...
                return block.getMaterial() == Material.AIR && Blocks.SNOW.canPlace(this, i, j, k);
            }
        ...
        if (chunk == null /*|| !chunk.areNeighborsLoaded(1)*/ /* !this.areChunksLoaded(i, j, k, 17)*/) {
                        ...
                        if (l2 > 0) {
                            ...
                            if (j3 + l3 + k3 < 17) {
                                for (int i4 = 0; i4 < 6; ++i4) {
                                    ...
                                    int i5 = FastMath.max(1, this.getType(j4, k4, l4).k());
            ...
            while (l < i1) {
                ...
                if (i3 != l2) {
                    ...
                    if (i3 > l2) {
                        j3 = FastMath.abs(i2 - i);
                        l3 = FastMath.abs(j2 - j);
                        k3 = FastMath.abs(k2 - k);
    ...
    public boolean mayPlace(Block block, int i, int j, int k, boolean flag, int l, Entity entity, ItemStack itemstack) {
        ...
        boolean defaultReturn = (axisalignedbb == null || this.a(axisalignedbb, entity)) && (block1.getMaterial() == Material.ORIENTABLE && block == Blocks.ANVIL || block1.getMaterial().isReplaceable() && block.canPlace(this, i, j, k, l, itemstack));
    ...
    public PathEntity findPath(Entity entity, Entity entity1, float f, boolean flag, boolean flag1, boolean flag2, boolean flag3) {
        ...
        int i = (int) FastMath.floor(entity.locX);
        int j = (int) FastMath.floor(entity.locY + 1.0D);
        int k = (int) FastMath.floor(entity.locZ);
        int l = (int) (f + 16.0F);
        int i1 = i - l;
        int j1 = j - l;
        int k1 = k - l;
    ...
    public PathEntity a(Entity entity, int i, int j, int k, float f, boolean flag, boolean flag1, boolean flag2, boolean flag3) {
        this.methodProfiler.a("pathfind");
        int l = (int) FastMath.floor(entity.locX);
        int i1 = (int) FastMath.floor(entity.locY);
        int j1 = (int) FastMath.floor(entity.locZ);
        int k1 = (int) (f + 8.0F);
        int l1 = l - k1;
        int i2 = i1 - k1;
        int j2 = j1 - k1;
    ...
    public int getBlockPower(int i, int j, int k) {
        byte b0 = 0;
        int l = FastMath.max(b0, this.getBlockPower(i, j - 1, k, 0));

        if (l >= 15) {
            return l;
        } else {
            l = FastMath.max(l, this.getBlockPower(i, j + 1, k, 1));
            if (l >= 15) {
                return l;
            } else {
                l = FastMath.max(l, this.getBlockPower(i, j, k - 1, 2));
                if (l >= 15) {
                    return l;
                } else {
                    l = FastMath.max(l, this.getBlockPower(i, j, k + 1, 3));
                    if (l >= 15) {
                        return l;
                    } else {
                        l = FastMath.max(l, this.getBlockPower(i - 1, j, k, 4));
                        if (l >= 15) {
                            return l;
                        } else {
                            l = FastMath.max(l, this.getBlockPower(i + 1, j, k, 5));
                            return l;
                        }
                    }
                }
    ...
    public boolean isRainingAt(int i, int j, int k) {
        if (!this.Q()) {
            ...
            return !biomebase.d() && (!this.e(i, j, k, false) && biomebase.e());
        }
    }
    ...
    public float b(double d0, double d1, double d2) {
        return this.B((int) FastMath.floor(d0), (int) FastMath.floor(d1), (int) FastMath.floor(d2));
    }
