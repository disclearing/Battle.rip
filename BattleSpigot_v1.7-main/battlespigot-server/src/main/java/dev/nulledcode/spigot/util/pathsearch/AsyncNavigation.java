package dev.nulledcode.spigot.util.pathsearch;

import dev.nulledcode.spigot.util.pathsearch.cache.SearchCacheEntry;
import dev.nulledcode.spigot.util.pathsearch.cache.SearchCacheEntryEntity;
import dev.nulledcode.spigot.util.pathsearch.cache.SearchCacheEntryPosition;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJob;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJobNavigationEntity;
import dev.nulledcode.spigot.util.pathsearch.jobs.PathSearchJobNavigationPosition;
...
public class AsyncNavigation extends Navigation {
    ...
    public boolean a(PositionPathSearchType type, double d0, double d1, double d2, double d3) {
        PathEntity pathentity = this.a(type, (double) FastMath.floor(d0), (double) ((int) d1), (double) FastMath.floor(d2));
    ...
    public PathEntity a(PositionPathSearchType type, double d0, double d1, double d2) {
        ...
        int x = (int) FastMath.floor(d0);
        int y = (int) d1;
        int z = (int) FastMath.floor(d2);
