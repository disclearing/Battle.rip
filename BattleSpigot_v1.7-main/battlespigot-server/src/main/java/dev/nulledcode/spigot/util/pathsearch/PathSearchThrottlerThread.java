...
import dev.nulledcode.spigot.util.NamePriorityThreadFactory;
...
public class PathSearchThrottlerThread extends ThreadPoolExecutor {
    ...
    public PathSearchThrottlerThread(int poolSize) {
        super(poolSize, poolSize, 1L, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(), new NamePriorityThreadFactory(Thread.MIN_PRIORITY, "BattleSpigot_PathFinder"));
        instance = this;
