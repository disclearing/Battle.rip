package dev.nulledcode.spigot.util.util;
...
public class BlockUtil {
    ...
    public static boolean isOnGround(final Location location, final int down) {
        ...
        final double fracX = (posX % 1.0 > 0.0) ? FastMath.abs(posX % 1.0) : (1.0 - FastMath.abs(posX % 1.0));
        final double fracZ = (posZ % 1.0 > 0.0) ? FastMath.abs(posZ % 1.0) : (1.0 - FastMath.abs(posZ % 1.0));
