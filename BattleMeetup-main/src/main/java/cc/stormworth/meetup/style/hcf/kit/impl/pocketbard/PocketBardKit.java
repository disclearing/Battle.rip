package cc.stormworth.meetup.style.hcf.kit.impl.pocketbard;
...
public class PocketBardKit extends HCFKit implements Listener {
    ...
    protected void loadInventory() {
        ...
        this.setChestplate(new HCFKitItem(Material.DIAMOND_CHESTPLATE)
                .setName(HCFKitItem.PREFIX_BLOOD + "Chestplate")
                .addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2)
                .addEnchantment(Enchantment.DURABILITY, 3)
        ...
        this.setLeggings(new HCFKitItem(Material.DIAMOND_LEGGINGS)
                .setName(HCFKitItem.PREFIX_BLOOD + "Leggings")
                .addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2)
                .addEnchantment(Enchantment.DURABILITY, 3)
                .get());
        this.setBoots(new HCFKitItem(Material.DIAMOND_BOOTS)
                .setName(HCFKitItem.PREFIX_BLOOD + "Boots")
                .addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2)
