...
public class ItemBuilder {
    ...
    public ItemBuilder(Material material, int amount, int itemDB, String name, List<String> lore) {
        is = new ItemStack(material, amount, (short) itemDB);
    ...
    public ItemBuilder(Material material, int itemDB, String name, List<String> lore) {
        is = new ItemStack(material, 1, (short) itemDB);
        ItemMeta meta = is.getItemMeta();
        meta.setDisplayName(name);
        meta.setLore(lore);
        is.setItemMeta(meta);
    ...
    public ItemBuilder(Material material, int itemDB, String name) {
        is = new ItemStack(material, 1, (short) itemDB);
        ItemMeta meta = is.getItemMeta();
        meta.setDisplayName(name);
        is.setItemMeta(meta);
    ...
    /**
     * Set the amount of the item you need in the ItemStack.
     *
