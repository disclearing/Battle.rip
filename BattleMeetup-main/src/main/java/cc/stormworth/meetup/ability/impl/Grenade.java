...
public class Grenade extends InteractAbility {
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        egg.setMetadata("RageBall", new FixedMetadataValue(Meetup.getInstance(), true));
    ...
    public void onProjectileHit(ProjectileHitEvent event) {
        ...
        for (Entity entity : egg.getNearbyEntities(5, 20, 5)) {
            ...
            if (GameManager.getInstance().getSpectators().contains(entity.getUniqueId())) return;
            ...
            target.setMetadata("grenade", new FixedMetadataValue(Meetup.getInstance(), true));
        }
    ...
    public void onDamage(EntityDamageEvent event) {
        ...
        if (event.getCause() == DamageCause.BLOCK_EXPLOSION
            ...
            player.removeMetadata("grenade", Meetup.getInstance());
        }
    }
