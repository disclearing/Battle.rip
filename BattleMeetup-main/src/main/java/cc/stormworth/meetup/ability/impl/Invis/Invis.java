package cc.stormworth.meetup.ability.impl.Invis;
...
public class Invis extends InteractAbility {
            ...
            if (player.hasPotionEffect(PotionEffectType.INVISIBILITY)) {
                ...
                for (PotionEffect activePotionEffect : player.getActivePotionEffects()) {
                    ...
                    if (activePotionEffect.getType().equals(PotionEffectType.INVISIBILITY)) {
                        //Main.getInstance().getEffectRestorer().getRestores().put(online.getUniqueId(), PotionEffectType.INVISIBILITY, activePotionEffect);
                    }
                }
            }
    ...
    private void showPlayer(Player player, boolean forced) {
        ...
        if (forced) {
      /*PotionEffect effect = Main.getInstance().getEffectRestorer().getRestores().remove(player.getUniqueId(), PotionEffectType.INVISIBILITY);
